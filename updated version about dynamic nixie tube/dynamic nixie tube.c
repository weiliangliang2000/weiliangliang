...
void interrupttime() interrupt 1 //to refresh the nixie tube every 1 millisecond;
{
	...
	if(second>=0&&second<10)
	{
		switch (s)
			{
				case 0:P20=1;P21=0;P22=1;s=0;P0=order[0];break;
				default:break;
			}
	}
		...
		switch (s)
			{
				...
				case 1:P20=0;P21=0;P22=1;s=0;P0=order[1];break;
				default:break;
			}
	}
		...
		switch (s)
			{
				...
				case 2:P20=1;P21=1;P22=0;s=0;P0=order[2];break;
				default:break;
			}
	}
	else if (second>=1000&&second<10000)
	{
		switch (s)
			{
				case 0:P20=1;P21=0;P22=1;s++;P0=order[0];break;
				...
				case 3:P20=0;P21=1;P22=0;s=0;P0=order[3];break;
				default:break;
			}
	}
	else if(second>=10000&&second<100000)
	{
		switch (s)
			{
				case 0:P20=1;P21=0;P22=1;s++;P0=order[0];break;
				...
				case 4:P20=1;P21=0;P22=0;s=0;P0=order[4];break;
				default:break;
			}
	}
	else
